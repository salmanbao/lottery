...
// File: contracts/interfaces/ISafemoonSwapLottery.sol
...
// File: contracts/SafemoonLottery.sol
...
contract SafemoonLottery is ReentrancyGuard, ISafemoonLottery, Ownable {
    ...
    uint256 public maxPriceTicketInSafemoon = 50 ether;
    uint256 public minPriceTicketInSafemoon = 0.005 ether;
     ...
     */
    constructor(address _safemoonTokenAddress, address _randomGeneratorAddress) {
    ...
    function startLottery(
        uint256 _endTime,
        uint256 _priceTicketInSafemoon,
        uint256 _discountDivisor, // TODO should remove
        uint256[6] calldata _rewardsBreakdown,
        uint256 _treasuryFee
        ...
        require(_discountDivisor >= MIN_DISCOUNT_DIVISOR, "Discount divisor too low"); // TODO will be removed
        ...
        _lotteries[currentLotteryId] = Lottery({
            ...
            discountDivisor: _discountDivisor, // TODO will be removed
    ...
    function calculateTotalPriceForBulkTickets(
        uint256 _discountDivisor, // TODO will be removed
    ...
    function _calculateTotalPriceForBulkTickets(
        ...
        uint256 discount = _discount(_numberTickets);
        uint256 totalCost = _priceTicket.mul(_numberTickets);

        return totalCost.sub(discount);
    }
